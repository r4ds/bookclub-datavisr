...
link-citations: yes
github-repo: r4ds/bookclub-datavisr
description: "This website is the product of the R4DS Online Learning Community's Data Visualization with R Book Club."
---

# Welcome {-}

Welcome to the Data Visualization with R book club! 

This website is a companion for the book [_Data Visualization with R_](https://rkabacoff.github.io/datavis/) by Rob Kabacoff (copyright 2020).
This companion is available at [r4ds.io/datavisr](https://r4ds.io/datavisr).
...
- More information about how to present is available in the [github repo](https://github.com/r4ds/bookclub-datavisr).
