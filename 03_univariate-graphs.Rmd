...
- `fill` fills color for the bars
- `color` controls the border color around the bars
- `bins` controls the number of bins into which the numeric variable is divided
- `binwidth` controls the width of the bins represented by the bars
- `bw` controls the degree of smoothness
