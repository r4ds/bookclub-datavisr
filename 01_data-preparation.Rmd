...
# calculating the mean height for women by species 
newdata <- starwars %>%
...
You can convert a wide dataset to a long dataset using `pivot_longer()`, and a long dataset to a wide dataset using `pivot_wider()`.
